<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">BEACUKAI KETAPANG</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-header">MENU PEMOHONAN LAYANAN</li>
            <li class="dropdown">
                <a href="table.html" class="nav-link"><i class="fas fa-th-large"></i>
                    <span>Table</span></a>
                {{-- <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="table.html">Table</a></li>
                    <li><a class="nav-link" href="components-user.html">User</a></li>
                    <li><a class="nav-link beep beep-sidebar" href="components-wizard.html">Wizard</a></li>
                </ul> --}}
            </li>
            <li class="dropdown">
                <a href="permohonan" class="nav-link"><i class="far fa-file-alt"></i>
            ...
            <li class="dropdown">
                <a href="surat-masuk.html" class="nav-link"><i class="fas fa-map-marker-alt"></i> <span>
                        Surat Masuk</span></a>
                {{-- <ul class="dropdown-menu">
